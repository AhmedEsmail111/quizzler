...
import 'package:quizes/data/dart/oop_quiz_brain.dart';
import 'package:quizes/widgets/dart/menu.dart';

OopQuizBrain _quizBrain = OopQuizBrain();

class OopQuizPage extends StatefulWidget {
  @override
  _OopQuizPageState createState() => _OopQuizPageState();
}

class _OopQuizPageState extends State<OopQuizPage> {
